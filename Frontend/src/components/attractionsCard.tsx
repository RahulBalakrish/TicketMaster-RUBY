...
import { Attractions } from '../Static/types';
...
const AttractionsCard: React.FC<{ otherNews: Attractions }> = ({ otherNews }) => {
    ...
    return (
        <div className='otherNews-card'>
            ...
            <div className='checkout_tabs'>
                ...
                <a onClick={handleCheckout} className='text-bottom' target='_blank'>{t(LOOKUP?.NEWS_COMPONENT?.PRICE)}<ArrowOutwardRoundedIcon sx={launchIcon} /></a>
            </div>
        </div>
    );
};
